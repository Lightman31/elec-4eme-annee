...
static int __init gpio_button_unprotected_infinite_led_blinker_init(void)
{ 
  int ret = 0;
...
static void __exit gpio_button_unprotected_infinite_led_blinker_exit(void)
{
  printk(KERN_INFO "%s\n", __func__);
...
module_init(gpio_button_unprotected_infinite_led_blinker_init);
module_exit(gpio_button_unprotected_infinite_led_blinker_exit);
